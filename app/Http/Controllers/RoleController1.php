...
class RoleController1 extends Controller
{
    ...
    {
        /*se buscan todos los permisos diponibles dentro del sitema 
        para poder asignar los que se deseen a un determinado rol*/
    $permissions = Permission::get();
    ...
    {
        $role->delete();
/*la siguiente linea elimina el roleo biscando por su id*/
